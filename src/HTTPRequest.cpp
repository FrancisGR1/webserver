...
const std::string& HTTPRequest::target() const { return m_target; }
...
static void print_field(std::ostream& os, const std::string& title, const std::string& value, int width = 10)
{
...
std::ostream& operator<<(std::ostream& os, const HTTPRequest& request)
{
    ...
    print_field(os, "Target",  request.target());
